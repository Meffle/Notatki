...
*Proszę państwa do gazu* to opowiadanie obozowe.

**Opowiadanie obozowe** - takie, które tematyką dotyka realiów obozu.

Tytuł opowiadania ma charakter ironiczny, który jeszcze bardziej podkreśla tragizm przedstawionych wydarzeń - wszechobecnej śmierci w obozach. 
*Proszę państwa do gazu* ma udawać zwrot esesmanów, którzy w ten sposób mieliby się zwracać do więźniów obozów, a zwrot ten byłby zapowiedzią śmierci. Ironia w tym tytule polega na zestawieniu zwrotu grzecznościowego z zaproszeniem do śmierci. 
...
Tadek nie może zrozumieć swojej złości wobec transportowanych więźniów, twierdzi, że to patologiczne, że chciałby się na nich rzucić. Narrator jest sfrustrowany tym, ile pracy musi przez te transporty wykonywać. 
...
Człowiek jest dehumanizowany, co przejawia się jego stopniową obojętnością na smierć. [[Literatura wojenna#^300fb4|Związane jest to z tym, że człowiek jest tylko przedmiotem. Jest tylko kimś, a raczej czymś, co Rzesza wykorzystuje]]. Człowiek musi pozbyć się współczucia, wrażliwości, stać się bezemocjonalnym tworem, aby móc jakkolwiek przetrwać w nieludzkich warunkach.

Narracja Borowskiego jest dualistyczna i niemal pozbawiona emocji, jest skupiona na konkretnym opisywaniu rzeczywistości. Opisy w opowiadaniach Borowskiego są szczegółowe i drobiazgowe. Język jest pełen zwrotów typowych dla obozu, jest surowy, prosty, bezpośredni, kolokwialny i wulgarny. 
Styl jest pozornie pozbawiony emocji, żeby podkreślić codzienność i przyzwyczajenie narratora do tragedii opisywanej w opowiadaniach. Borowski rezygnuje z wyszukanych środków stylistycznych, chce żeby tekst miał charakter dokumentalny. 