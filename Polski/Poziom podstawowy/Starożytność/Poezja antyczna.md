...
### Cechy artysty (jak opisany jest w utworze):
- dumny ze swoich osiągnięć i sławy,
- chce być zapamiętany, ponadczasowy,
- pewny swojego talentu, utalentowany,
- zarozumiały.

W utworze pojawia się wątek biograficzny – podmiot liryczny nawiązuje do pochodzenia z nizin społecznych.
#  Poeci antyczni
- **Tyrteusz** – poeta, który nawoływał do walki, swoją poezją zachęcał do podejmowania działań zbrojnych, stąd _poezja tyrtejska_. Uważał, że dumą i honorem jest umrzeć na polu walki.
